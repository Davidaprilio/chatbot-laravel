        ...
        <div class="chat-users">
            <div class="chat-users__top">
                ...
                <div class="chat-users__top-right">
                    <button class="chat-users__button-add-users button-icon button-icon--small" data-toggle="users-add-list"><span class="button-icon__icon">
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-teal">
                                ...
                                <img src="{{ url('/') }}/assets/img/content/humans/item-8.jpg" alt="#">
                            </div>
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-green">
                                ...
                                <img src="{{ url('/') }}/assets/img/content/humans/item-10.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-teal">
                                ...
                                <img src="{{ url('/') }}/assets/img/content/humans/item-5.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-orange">
                                ...
                                <img src="{{ url('/') }}/assets/img/content/humans/item-2.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-orange-dark">
                                ...
                                <img src="{{ url('/') }}/assets/img/content/humans/item-1.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-green">
                                ...
                                <img src="{{ url('/') }}/assets/img/content/humans/item-6.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-red">
                                ...
                                <img src="{{ url('/') }}/assets/img/content/humans/item-3.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-orange-dark">
                                ...
                                <img src="{{ url('/') }}/assets/img/content/humans/item-7.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-orange">
                                ...
                                <img src="{{ url('/') }}/assets/img/content/humans/item-9.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
            ...
            <div class="chat-users__content scrollbar-thin scrollbar-hidden" data-simplebar>
                <ul class="chat-users__list">
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-orange-dark">
                                <div class="chat-users__item-avatar-text">FB</div><span class="badge-signal badge-signal--green"></span>
                                <img src="{{ url('/') }}/assets/img/content/humans/item-1.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
                                <h5 class="chat-users__item-name">Felecia Burke</h5>
                                ...
                                <div class="chat-users__item-message">
                                    <div class="chat-users__item-badge"><span class="badge badge--small badge--red">5</span>
                                    </div>
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item active" href="#">
                            <div class="chat-users__item-avatar color-red">
                                <div class="chat-users__item-avatar-text">JB</div><span class="badge-signal badge-signal--green"></span>
                                <img src="{{ url('/') }}/assets/img/content/humans/item-4.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
                                <h5 class="chat-users__item-name">Joan Bates</h5>
                                <div class="chat-users__item-right-group"><span class="chat-users__item-time">5 min</span>
                                </div>
                                <div class="chat-users__item-message">
                                    <div class="chat-users__item-badge"><span class="badge badge--small badge--red">3</span>
                                    </div>
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            ...
                            <div class="chat-users__item-right">
                                <h5 class="chat-users__item-name">David Palmer</h5>
                                <div class="chat-users__item-right-group"><span class="chat-users__item-time">15 min</span>
                                </div>
                                <div class="chat-users__item-message">
                                    <div class="chat-users__item-badge"><span class="badge badge--small badge--red">3</span>
                                    </div>
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-orange">
                                <div class="chat-users__item-avatar-text">ED</div><span class="badge-signal badge-signal--green"></span>
                                <img src="{{ url('/') }}/assets/img/content/humans/item-2.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
                                <h5 class="chat-users__item-name">Elaine Day</h5>
                                <div class="chat-users__item-right-group"><span class="chat-users__item-time">17 min</span>
                                </div>
                                <div class="chat-users__item-message">
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            ...
                            <div class="chat-users__item-right">
                                <h5 class="chat-users__item-name">Morris Stevens</h5>
                                <div class="chat-users__item-right-group"><span class="chat-users__item-time">30 min</span>
                                </div>
                                <div class="chat-users__item-message">
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-orange-dark">
                                <div class="chat-users__item-avatar-text">TR</div><span class="badge-signal badge-signal--green"></span>
                                <img src="{{ url('/') }}/assets/img/content/humans/item-7.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
                                <h5 class="chat-users__item-name">Troy Russell</h5>
                                <div class="chat-users__item-right-group"><span class="chat-users__item-time">40 min</span>
                                </div>
                                <div class="chat-users__item-message">
                                    <div class="chat-users__item-badge"><span class="badge badge--small badge--red">4</span>
                                    </div>
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-teal">
                                <div class="chat-users__item-avatar-text">BH</div><span class="badge-signal badge-signal--green"></span>
                                <img src="{{ url('/') }}/assets/img/content/humans/item-8.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
                                <h5 class="chat-users__item-name">Billy Hicks</h5>
                                <div class="chat-users__item-right-group"><span class="chat-users__item-time">1 hours</span>
                                </div>
                                <div class="chat-users__item-message">
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            <div class="chat-users__item-avatar color-red">
                                <div class="chat-users__item-avatar-text">NS</div><span class="badge-signal badge-signal--green"></span>
                                <img src="{{ url('/') }}/assets/img/content/humans/item-3.jpg" alt="#">
                            </div>
                            <div class="chat-users__item-right">
                                <h5 class="chat-users__item-name">Nora Stanley</h5>
                                <div class="chat-users__item-right-group"><span class="chat-users__item-time">3 hours</span>
                                </div>
                                <div class="chat-users__item-message">
                    ...
                    <li class="chat-users__list-item">
                        <a class="chat-users__item" href="#">
                            ...
                            <div class="chat-users__item-right">
                                <h5 class="chat-users__item-name">Walter Miles</h5>
                                <div class="chat-users__item-right-group"><span class="chat-users__item-time">1 week</span>
                                </div>
                                <div class="chat-users__item-message">
                ...
                <div class="chat-details__top-left">
                    ...
                    <a class="media-item media-item--medium" href="#">
                        <div class="media-item__icon color-red">
                            ...
                            <img class="media-item__thumb" src="{{ url('/') }}/assets/img/content/humans/item-4.jpg" alt="#">
                        </div>
                            ...
                            <div class="chat-message__messages">
                                <div class="chat-message__message-group">
                                    <div class="chat-message__message-item">
                                        <p class="chat-message__item-text">Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet.
                                            <img src="{{ url('/') }}/assets/img/content/emoji-happy.svg" alt="#" />
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="chat-message__content">
                        ...
                        <div class="chat-message__right">
                            <div class="chat-message__messages">
                                <div class="chat-message__message-group">
                                    <div class="chat-message__message-item">
                                        <p class="chat-message__item-text">Sed ut perspiciatis, qui in ea voluptate velit esse, quam nihil molestiae?</p>
                                    </div>
                        ...
                        <div class="chat-message__files">
                            <div class="chat-message__files-items">
                                <div class="chat-message__file">
                                    <img src="{{ url('/') }}/assets/img/content/message-file-1@2x.jpg" width="56" alt="#" />
                                </div>
                                <div class="chat-message__file">
                                    <img src="{{ url('/') }}/assets/img/content/message-file-2@2x.jpg" width="56" alt="#" />
                                </div>
                                <div class="chat-message__file">
                                    <img src="{{ url('/') }}/assets/img/content/message-file-3@2x.jpg" width="56" alt="#" />
                                </div>
                            </div>
                    ...
                    <div class="chat-message__content">
                        ...
                        <div class="chat-message__right">
                            <div class="chat-message__messages">
                                <div class="chat-message__message-group">
                                    <div class="chat-message__message-item">
                                        <p class="chat-message__item-text">voluptatem sequi nesciunt neque porro obcaecati cupiditate. non provident similique sunt.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="chat-message__content">
                        ...
                        <div class="chat-message__right">
                            <div class="chat-message__messages">
                                <div class="chat-message__message-group">
                                    <div class="chat-message__message-item">
                                        <p class="chat-message__item-text">Excepteur sint occaecat cupidatat non proident, quia voluptas sit, aspernatur aut odit aut fugit.
                                            <img src="{{ url('/') }}/assets/img/content/emoji/shocked.svg" alt="#" />
                                        </p>
                                    </div>
                    ...
                    <div class="chat-message__content">
                        ...
                        <div class="chat-message__right">
                            <div class="chat-message__messages">
                                <div class="chat-message__message-group">
                                    <div class="chat-message__message-item">
                                        <p class="chat-message__item-text">Itaque earum rerum hic tenetur a sapiente delectus quia voluptas sit, aspernatur aut odit aut fugit sed.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="chat-message__message-item">
                                        <div class="media-file">
                                            <div class="media-file__icon">
                                                <img class="media-file__thumb" src="{{ url('/') }}/assets/img/content/file-pdf.svg" alt="#" />
                                            </div>
                            ...
                            <div class="dropdown-emoji dropdown-menu dropdown-menu--up">
                                <div class="dropdown-emoji__content">
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/laughing.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/happy-2.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/crazy.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/bad.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/angry.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/happy.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/thinking.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/sad.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/pressure.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/in-love.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/nerd.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/happy-3.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/shocked.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/wink.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/sweating.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/shocked-2.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/shocked-3.svg" alt="#" />
                                    </a>
                                    <a class="dropdown-emoji__item" href="#" tabindex="0">
                                        <img class="dropdown-emoji__image" src="{{ url('/') }}/assets/img/content/emoji/sad-2.svg" alt="#" />
                                    </a>
                                </div>
                            </div>
                        </div>
