                ...
                <div class="card mb-3">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <button id="btnReload" type="button" class="btn btn-outline-secondary"><i
                                    class="fa fa-reload"></i> Reload Data</button>
                    ...
                    <div class="card-body">
                        <form id="frmEdit" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control item-menu" id="description" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="validasi">Validasi Jawaban</label>
                                <select name="validasi" id="validasi" class="form-control item-menu">
                                    <option value="">--</option>
                                    <option value="name">Nama</option>
                                    <option value="location">Location (Shareloc)</option>
                                </select>
                            </div>
                            <div class="form-group d-none" id="q_val">
                                <label for="qa_validasi">Pertanyaan ?</label>
                                <textarea name="qa_validasi" class="form-control item-menu" id="qa_validasi" rows="3"></textarea>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $("#btnUpdate").click(function() {
                let uuid = $('#uuid').val();
                if (uuid == '') {
                    $('#uuid').val(Math.random().toString(36).substring(7));
                }
                editor.update();
                saveJson();
            });
            ...
            //     let val = $(this).val();
            //     if (val == 'name') {
            //         $('#q_val').removeClass('d-none');
            //     } else {
            //         $('#q_val').addClass('d-none');
            //     }
            // });
            // setInterval(() => {
            //     $('#validasi').trigger('change');
            // }, 1000);
